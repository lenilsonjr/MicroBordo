...
(function($) {
    (function() {
        ...
        jQuery(function() {
            $.tags = function(element, options) {
                ...
                this.promptText || (this.promptText = "Digite marcadores...");
                this.caseInsensitive || (this.caseInsensitive = false);
                this.readOnlyEmptyMessage || (this.readOnlyEmptyMessage = "Sem marcadores para mostrar...");
                ...
                this.adjustInputPosition = function() {
                    ...
                    if (Math.max(pLeft, 0) == 0) {

                        padLeft = '15px';

                    } else {

                        padLeft = Math.max(pLeft, 0);

                    }
                    if (Math.max(pTop, 0) == 0) {

                        padTop = '5px';

                    } else {

                        padTop = Math.max(pTop, 0);
    ...
    (function() {
        ...
        Tags.Templates["2"].input = function(options) {
            ...
            return "<input type='text' name='tags' class='tags-input input-" + tagSize + "' />";
        };
    }).call(this);
    (function() {
        var _base;
